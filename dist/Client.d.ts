...
export declare class Client extends Eris.Client {
     ...
     */
    slashCommandIDs: Map<string, SlashCommand>;
    /**
    ...
    */
     ...
     * @private
     */
    _performFirstReadySetup(): Promise<void>;
     ...
     * returns `false`.
     */
    processApplicationCommandResponse(interaction: Eris.AnyInteraction | Eris.UnknownInteraction): Promise<boolean>;
